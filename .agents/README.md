...
- **Installed revision or release:** `0.1.14`; npm distribution integrity `sha512-DoKzrzEN/ivdxFy61Kbqzsz/U4+6F6Nk1Psu9hSYYYriqhzifW57VuNciuXjFS5Xuyhb8aXcy5hCgbDdqr3EIg==`.
- **Installation and generation command:** existing global CLI verification with `playwright-cli --version` and `playwright-cli --help`; isolated generation with `playwright-cli install --skills`.
- **Installation date:** `2026-07-22` (UTC).
