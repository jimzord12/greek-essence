...
|---|---|---:|
| 00 — Planning and baseline | Ready | 0/2 |
...
- The root integrator selects dependency-ready work, delegates it, reconciles repository-wide state, updates tracking, and controls phase commits. It does not implement delegated tasks or review its own work.
